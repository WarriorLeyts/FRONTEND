  ...
  return (
    ...
    <div className={styles.secondSetting}>
        <div className="block-input">
          ...
          <textarea type="text" name="info" className="input" style={{width: "600px", height: "80px", resize: "none"}}/>
        </div>
        <div className="block-input">
          <label className='input-label'>Геолокация</label>
          <input type="text" name="location" className="input" style={{width: "600px", height: "52px"}}/>
        </div>
        <div className="block-input">
          <label className='input-label'>Веб-сайт</label>
          <input type="text" name="web" className="input" style={{width: "600px", height: "52px"}}/>
        </div>
